...
@Component({
  selector: 'app-cashflows-table',
  templateUrl: './cashflows-table.component.html',
})
export class CashflowsTableComponent {
  @Input() cashflows: CashflowSummary[];
  @Input() public hasUnprocessedCashflows: boolean;
  ...
  public columns: GdsColumn[] = [...cashflowsTableColumns];
}
